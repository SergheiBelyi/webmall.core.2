...
namespace Webmall.Model.CoreHelpers
{
    ...
    public static class Число
    {
        ...
        {
            if (число == 0.0) return; // конец рекурсии
        ...
        class ЦифраИзменяющаясяПоРодам : Цифра, IИзменяетсяПоРодам
        {
            ...
            private readonly string _мужской;
            private readonly string _женский;
            private readonly string _средний;
            private readonly string _множественное;

            #region IИзменяетсяПоРодам Members

            public string Мужской => _мужской;
            public string Женский => _женский;
            public string Средний => _средний;
            public string Множественное => _множественное;
        ...
        {
            public string ИменЕдин => "тысяча";
            public string РодЕдин => "тысячи";
            public string РодМнож => "тысяч";
        ...
        {
            readonly string _начальнаяФорма;

            public Класс(string начальнаяФорма)
            {
                _начальнаяФорма = начальнаяФорма;
            }

            public string ИменЕдин => _начальнаяФорма;
            public string РодЕдин => _начальнаяФорма + "а";
            public string РодМнож => _начальнаяФорма + "ов";
        ...
        private static double _maxDouble = 0;
    ...
    public class Валюта
    {
        ...
        readonly IЕдиницаИзмерения _основная;
        readonly IЕдиницаИзмерения _дробная;

        /// <summary>
        /// Основная единица измерения валюты - рубли, доллары, евро и т.д.
        /// </summary>
        public IЕдиницаИзмерения ОсновнаяЕдиница => _основная;

        /// <summary>
        /// Дробная единица измерения валюты - копейки, центы, евроценты и т.д.
        /// </summary>
        public IЕдиницаИзмерения ДробнаяЕдиница => _дробная;
        ...
        public static readonly Валюта Лей = new Валюта(
            new ЕдиницаИзмерения(РодЧисло.Мужской, "лей", "лея", "леев"),
            new ЕдиницаИзмерения(РодЧисло.Мужской, "бан", "бана", "банов"));
    ...
    public class ЕдиницаИзмерения : IЕдиницаИзмерения
    {
        ...
        readonly РодЧисло _родЧисло;
        readonly string _именЕдин;
        readonly string _родЕдин;
        readonly string _родМнож;

        #region IЕдиницаИзмерения Members

        string IЕдиницаИзмерения.ИменЕдин => _именЕдин;

        string IЕдиницаИзмерения.РодЕдин => _родЕдин;

        string IЕдиницаИзмерения.РодМнож => _родМнож;
    ...
    public abstract class РодЧисло : IЕдиницаИзмерения
    {
        ...
        string IЕдиницаИзмерения.ИменЕдин => null;

        string IЕдиницаИзмерения.РодЕдин => null;

        string IЕдиницаИзмерения.РодМнож => null;

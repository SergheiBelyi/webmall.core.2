...
namespace Webmall.Model.Entities.Order
{
    public class OrderListItem
    {
        ...
        /// </summary>
        public List<PositionStatus> PosStatuses  { get; set; }
        ...
        public DateTime? DeliveryTime => 
            DeliveryInfo.DeliveryTypeId == 1
            ? DeliveryInfo.PickUpPayload.PickupTime
            : DeliveryInfo.DeliveryPayload.DeliveryTime.Date;

...
namespace Laximo.Guayaquil.Data.net.laximo.ws {
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="CatalogSoap11Binding", Namespace="http://WebCatalog.Kito.ec")]
    public partial class Catalog : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public Catalog() {
            this.Url = global::Laximo.Guayaquil.Data.Properties.Settings.Default.Laximo_Guayaquil_Data_net_laximo_ws_Catalog;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("urn:QueryData", RequestNamespace="http://WebCatalog.Kito.ec", ResponseNamespace="http://WebCatalog.Kito.ec", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("urn:QueryDataLogin", RequestNamespace = "http://WebCatalog.Kito.ec", ResponseNamespace = "http://WebCatalog.Kito.ec", Use = System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle = System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        [return: System.Xml.Serialization.XmlElementAttribute("return", IsNullable = true)]
        public string QueryDataLogin([System.Xml.Serialization.XmlElementAttribute(IsNullable = true)] string request,
            [System.Xml.Serialization.XmlElementAttribute(IsNullable = true)] string login,
            [System.Xml.Serialization.XmlElementAttribute(IsNullable = true)] string hmac)
        {
            object[] results = this.Invoke("QueryDataLogin", new object[] {
                        request,login,hmac});
            return ((string)(results[0]));
        }

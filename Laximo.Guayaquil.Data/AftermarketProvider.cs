...
namespace Laximo.Guayaquil.Data
{
    ...
    {
        public AftermarketProvider(string certPath, string certPwd, string authMode, string login, string password,
            ICatalogCache cache) : base(certPath, certPwd, authMode, login, password, cache)
        {
        }

        public AftermarketProvider(string certPath, string certPwd, string authMode, string login, string password,
            ICatalogCache cache, string locale) : base(certPath, certPwd, authMode, login,password, cache, locale)
        {
        }

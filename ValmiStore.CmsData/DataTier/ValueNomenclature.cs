	...
	public class ValueNomenclature:Value
	{
		...
		public override SqlParameter GetSQLParam(string pName)
		{
			...
			else		
			{
				...
				{
					throw new InvalidCastException("В значение ValueNomenclature произошла ошибка преобразования типов: oValue не правильного типа его тип: "+oValue.GetType().ToString());
				}
			}			
			return param;
		}
